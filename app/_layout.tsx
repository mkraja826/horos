...
function Navigation() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="life-profile" options={{ title: "My Life Profile" }} />
      <Stack.Screen name="year-analysis" options={{ title: "Year analysis" }} />
      <Stack.Screen name="month-analysis" options={{ title: "Month analysis" }} />
